...
public class SkuBoundsController {
    ...
    public ResponseVo<List<ItemSalesVo>> queryItemSalesBySkuId(@PathVariable("skuId")Long skuId){
        List<ItemSalesVo> itemSalesVos = this.skuBoundsService.queryItemSalesBySkuId(skuId);
